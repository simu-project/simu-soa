package com.simu.soa.support.config;

import com.simu.soa.support.config.shardingDatabase.ShardingDataSouceConfig;
...
//@MapperScan(basePackages = "com.simu.soa.mapper")
